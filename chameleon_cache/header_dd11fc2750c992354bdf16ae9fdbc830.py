...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '// define the newgrf\ngrf {\n\tgrfid: "\\41\\4E\\02\\01";\n\tname: string(STR_GRF_NAME);\n\tdesc: string(STR_GRF_DESCRIPTION);\n\tversion: ${repo_vars.repo_version};\n\tmin_compatible_version: 1455;\n\tparam 0 {\n        param_reset_construction_costs {\n            type:    bool;\n            name:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS);\n            desc:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS_DESC);\n            bit: 0;\n            def_value: 1;\n        }\n    }\n\tparam 1 {\n        param_adjust_ship_speed {\n            type:    int;\n            name:    string(STR_PARAM_ADJUST_SHIP_SPEEDS);\n            min_value: 0;\n            max_value: 2;\n            def_value: 1;\n            names: {\n                0: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_0);\n                1: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_1);\n                2: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_2);\n            };\n        }\n    }\n\tparam 2 {\n\t\tparam_roster {\n\t\t\tname: string(STR_PARAM_ROSTER);\n\t\t\tdesc: string(STR_PARAM_ROSTER_DESC);\n\t\t\tmin_value: 0;\n\t\t\tmax_value: ${len(registered_rosters)-1};\n\t\t\tnames: {\n\t\t\t    ' (1:0)> braces_required=True translation=False at 7efdb0558630> -> __content_139628066513336
            __token = 0
            __token = 128
            __content_139628066513336 = _lookup_attr(getitem('repo_vars'), 'repo_version')
            __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
            __token = 1054
            __content_139628066513336_1052 = (len(getitem('registered_rosters')) - 1)
            __content_139628066513336_1052 = __quote(__content_139628066513336_1052, '\x00', '&#0;', None, False)
            __content_139628066513336 = ('%s%s%s%s%s' % ('// define the newgrf\ngrf {\n\tgrfid: "\\41\\4E\\02\\01";\n\tname: string(STR_GRF_NAME);\n\tdesc: string(STR_GRF_DESCRIPTION);\n\tversion: ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), ';\n\tmin_compatible_version: 1455;\n\tparam 0 {\n        param_reset_construction_costs {\n            type:    bool;\n            name:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS);\n            desc:    string(STR_PARAM_RESET_CONSTRUCTION_COSTS_DESC);\n            bit: 0;\n            def_value: 1;\n        }\n    }\n\tparam 1 {\n        param_adjust_ship_speed {\n            type:    int;\n            name:    string(STR_PARAM_ADJUST_SHIP_SPEEDS);\n            min_value: 0;\n            max_value: 2;\n            def_value: 1;\n            names: {\n                0: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_0);\n                1: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_1);\n                2: string(STR_PARAM_ADJUST_SHIP_SPEEDS_OPTION_2);\n            };\n        }\n    }\n\tparam 2 {\n\t\tparam_roster {\n\t\t\tname: string(STR_PARAM_ROSTER);\n\t\t\tdesc: string(STR_PARAM_ROSTER_DESC);\n\t\t\tmin_value: 0;\n\t\t\tmax_value: ', (__content_139628066513336_1052 if (__content_139628066513336_1052 is not None) else ''), ';\n\t\t\tnames: {\n\t\t\t    ', ))
            ...
            __backup_roster_139628075819808 = get('roster', __marker)

            # <Value 'registered_rosters' (38:35)> -> __iterator
            __token = 1129
            __iterator = getitem('registered_rosters')
            (__iterator, ____index_139628050220928, ) = getitem('repeat')('roster', __iterator)
            econtext['roster'] = None
            for __item in __iterator:
                econtext['roster'] = __item

                # <Interpolation value=<Substitution '\n                    ${roster.numeric_id - 1}: string(STR_PARAM_ROSTER_OPTION_${roster.numeric_id - 1});\n\t\t\t    ' (38:55)> braces_required=True translation=False at 7efdb05587b8> -> __content_139628066513336
                __token = 1170
                __token = 1172
                __content_139628066513336 = (_lookup_attr(getitem('roster'), 'numeric_id') - 1)
                __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
                __token = 1229
                __content_139628066513336_1227 = (_lookup_attr(getitem('roster'), 'numeric_id') - 1)
                __content_139628066513336_1227 = __quote(__content_139628066513336_1227, '\x00', '&#0;', None, False)
                __content_139628066513336 = ('%s%s%s%s%s' % ('\n                    ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), ': string(STR_PARAM_ROSTER_OPTION_', (__content_139628066513336_1227 if (__content_139628066513336_1227 is not None) else ''), ');\n\t\t\t    ', ))
                if (__content_139628066513336 is None):
                    pass
                else:
                    if (__content_139628066513336 is False):
                ...
                if (__content_139628066513336 is not None):
                    __append(__content_139628066513336)
                ____index_139628050220928 -= 1
                if (____index_139628050220928 > 0):
                    __append('')
            if (__backup_roster_139628075819808 is __marker):
                del econtext['roster']
            else:
                econtext['roster'] = __backup_roster_139628075819808

            # <Interpolation value=<Substitution '\n\t\t\t};\n\t\t}\n\t}\n}\n\n\nbasecost {\n \tPR_RUNNING_SHIP: 2;\n \tPR_BUILD_VEHICLE_SHIP: 2;\n}\n\nif (param_reset_construction_costs) {\n    basecost {\n \t    PR_BUILD_CANAL: -3;\n \t    PR_CLEAR_CANAL: -4;\n        PR_BUILD_AQUEDUCT: -2;\n        PR_CLEAR_AQUEDUCT: -4;\n        PR_BUILD_LOCK: -1;\n        PR_CLEAR_LOCK: -2;\n    }\n}\n\n// sort order\nsort(FEAT_SHIPS, ${[ship.numeric_id for ship in ships]});\n' (40:21)> braces_required=True translation=False at 7efdb05585c0> -> __content_139628066513336
            __token = 1279
            __token = 1620
            __content_139628066513336 = [_lookup_attr(getitem('ship'), 'numeric_id') for econtext['ship'] in getitem('ships')]
            __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
            __content_139628066513336 = ('%s%s%s' % ('\n\t\t\t};\n\t\t}\n\t}\n}\n\n\nbasecost {\n \tPR_RUNNING_SHIP: 2;\n \tPR_BUILD_VEHICLE_SHIP: 2;\n}\n\nif (param_reset_construction_costs) {\n    basecost {\n \t    PR_BUILD_CANAL: -3;\n \t    PR_CLEAR_CANAL: -4;\n        PR_BUILD_AQUEDUCT: -2;\n        PR_CLEAR_AQUEDUCT: -4;\n        PR_BUILD_LOCK: -1;\n        PR_CLEAR_LOCK: -2;\n    }\n}\n\n// sort order\nsort(FEAT_SHIPS, ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), ');\n', ))
            if (__content_139628066513336 is None):
                pass
            else:
                if (__content_139628066513336 is False):
