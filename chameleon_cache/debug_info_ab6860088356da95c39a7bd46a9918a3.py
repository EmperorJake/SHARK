# -*- coding: utf-8 -*-
__filename = '/mnt/c/Users/Jakob/Games/GitHub/SHARK/src/templates/debug_info.pynml'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '// -- begin ${ship.title} -- ' (1:0)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f8037821850> -> __content_140188669528304
            __token = 0
            __token = 14
            ...
            __content_140188669528304 = ('%s%s%s' % ('// -- begin ', (__content_140188669528304 if (__content_140188669528304 is not None) else ''), ' -- ', ))
