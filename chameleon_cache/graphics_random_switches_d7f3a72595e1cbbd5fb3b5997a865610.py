...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            get = econtext.get
            __backup_year_139628075861272 = get('year', __marker)
            ...
            (__iterator, ____index_139628050342912, ) = getitem('repeat')('year', __iterator)
            econtext['year'] = None
            for __item in __iterator:
                econtext['year'] = __item

                # <Interpolation value=<Substitution '\n    random_switch (FEAT_SHIPS, SELF, ${ship.id}_switch_graphics_random_${year}) {\n        ' (1:99)> braces_required=True translation=False at 7efdb0576588> -> __content_139628066513336
                __token = 104
                __token = 139
                ...
                __token = 173
                __content_139628066513336_171 = getitem('year')
                __content_139628066513336_171 = __quote(__content_139628066513336_171, '\x00', '&#0;', None, False)
                __content_139628066513336 = ('%s%s%s%s%s' % ('\n    random_switch (FEAT_SHIPS, SELF, ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), '_switch_graphics_random_', (__content_139628066513336_171 if (__content_139628066513336_171 is not None) else ''), ') {\n        ', ))
                ...
                __backup_variation_num_139628075862056 = get('variation_num', __marker)
                ...
                (__iterator, ____index_139628050342688, ) = getitem('repeat')('variation_num', __iterator)
                econtext['variation_num'] = None
                for __item in __iterator:
                    econtext['variation_num'] = __item

                    # <Interpolation value=<Substitution '\n            1: return ${ship.id}_switch_graphics_${variation_num};\n        ' (3:115)> braces_required=True translation=False at 7efdb0576f28> -> __content_139628066513336
                    __token = 310
                    __token = 322
                    __content_139628066513336 = _lookup_attr(getitem('ship'), 'id')
                    __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
                    __token = 349
                    __content_139628066513336_347 = getitem('variation_num')
                    __content_139628066513336_347 = __quote(__content_139628066513336_347, '\x00', '&#0;', None, False)
                    __content_139628066513336 = ('%s%s%s%s%s' % ('\n            1: return ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), '_switch_graphics_', (__content_139628066513336_347 if (__content_139628066513336_347 is not None) else ''), ';\n        ', ))
                    if (__content_139628066513336 is None):
                        pass
                    else:
                        if (__content_139628066513336 is False):
                    ...
                    if (__content_139628066513336 is not None):
                        __append(__content_139628066513336)
                    ____index_139628050342688 -= 1
                    if (____index_139628050342688 > 0):
                        __append('')
                if (__backup_variation_num_139628075862056 is __marker):
                    del econtext['variation_num']
                else:
                    econtext['variation_num'] = __backup_variation_num_139628075862056
                __append('\n    }\n')
                ____index_139628050342912 -= 1
                if (____index_139628050342912 > 0):
                    __append('')
            if (__backup_year_139628075861272 is __marker):
                del econtext['year']
            else:
                econtext['year'] = __backup_year_139628075861272

            # <Interpolation value=<Substitution '\n\n\nswitch (FEAT_SHIPS, SELF, ${ship.id}_switch_graphics, build_year) {\n    ' (7:41)> braces_required=True translation=False at 7efdb0576550> -> __content_139628066513336
            __token = 457
            __token = 485
            __content_139628066513336 = _lookup_attr(getitem('ship'), 'id')
            __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
            __content_139628066513336 = ('%s%s%s' % ('\n\n\nswitch (FEAT_SHIPS, SELF, ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), '_switch_graphics, build_year) {\n    ', ))
            if (__content_139628066513336 is None):
                pass
            else:
                if (__content_139628066513336 is False):
            ...
            if (__content_139628066513336 is not None):
                __append(__content_139628066513336)
            __backup_nml_fragment_139628050455800 = get('nml_fragment', __marker)
            ...
            (__iterator, ____index_139628050343864, ) = getitem('repeat')('nml_fragment', __iterator)
            econtext['nml_fragment'] = None
            for __item in __iterator:
                econtext['nml_fragment'] = __item

                # <Interpolation value=<Substitution '\n        ${nml_fragment};\n    ' (11:118)> braces_required=True translation=False at 7efdb05769e8> -> __content_139628066513336
                __token = 652
                __token = 654
                __content_139628066513336 = getitem('nml_fragment')
                __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
                ...
                if (__content_139628066513336 is not None):
                    __append(__content_139628066513336)
                ____index_139628050343864 -= 1
                if (____index_139628050343864 > 0):
                    __append('')
            if (__backup_nml_fragment_139628050455800 is __marker):
                del econtext['nml_fragment']
            else:
                econtext['nml_fragment'] = __backup_nml_fragment_139628050455800

            # <Interpolation value=<Substitution '\n    return ${ship.id}_switch_graphics_random_0;\n}\n' (13:39)> braces_required=True translation=False at 7efdb0576470> -> __content_139628066513336
            __token = 713
            __token = 722
            __content_139628066513336 = _lookup_attr(getitem('ship'), 'id')
            __content_139628066513336 = __quote(__content_139628066513336, '\x00', '&#0;', None, False)
            __content_139628066513336 = ('%s%s%s' % ('\n    return ', (__content_139628066513336 if (__content_139628066513336 is not None) else ''), '_switch_graphics_random_0;\n}\n', ))
            if (__content_139628066513336 is None):
                pass
            else:
                if (__content_139628066513336 is False):
