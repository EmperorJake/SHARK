...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_cargo_139818190937784 = get('cargo', __marker)

            # <Value 'global_constants.cargo_labels' (8:41)> -> __iterator
            __token = 203
            __iterator = _lookup_attr(getitem('global_constants'), 'cargo_labels')
            (__iterator, ____index_139818165733360, ) = getitem('repeat')('cargo', __iterator)
            econtext['cargo'] = None
            for __item in __iterator:
                econtext['cargo'] = __item

                # <Interpolation value=<Substitution '\n    ${cargo},\n    ' (8:72)> braces_required=True translation=False at 7f29f41a0978> -> __content_139818181960344
                __token = 239
                __token = 241
                __content_139818181960344 = getitem('cargo')
                ...
                ____index_139818165733360 -= 1
                if (____index_139818165733360 > 0):
                    __append('')
            if (__backup_cargo_139818190937784 is __marker):
                del econtext['cargo']
            else:
                econtext['cargo'] = __backup_cargo_139818190937784
            __append('\n}\n')
        except:
