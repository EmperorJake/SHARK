# -*- coding: utf-8 -*-
__filename = '/home/jake/GRF/fish1672/src/docs_templates/readme.pt'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            __backup_ship_139865821092776 = get('ship', __marker)

            # <Value 'ships' (3:35)> -> __iterator
            __token = 76
            __iterator = getitem('ships')
            (__iterator, ____index_139865819861568, ) = getitem('repeat')('ship', __iterator)
            econtext['ship'] = None
            for __item in __iterator:
                econtext['ship'] = __item

                # <Interpolation value=<Substitution "${ship.title} ${' ' * (28-len(ship.title))} Introduced: ${ship.intro_date}; Speed: ${ship.speed}mph" (3:42)> braces_required=True translation=False at 7f350c825cf8> -> __content_139865838111856
                __token = 83
                __token = 85
                ...
                __token = 99
                __content_139865838111856_97 = (' ' * (28 - len(_lookup_attr(getitem('ship'), 'title'))))
                __content_139865838111856_97 = __quote(__content_139865838111856_97, '\x00', '&#0;', None, False)
                __token = 141
                __content_139865838111856_139 = _lookup_attr(getitem('ship'), 'intro_date')
                __content_139865838111856_139 = __quote(__content_139865838111856_139, '\x00', '&#0;', None, False)
                __token = 168
                __content_139865838111856_166 = _lookup_attr(getitem('ship'), 'speed')
                __content_139865838111856_166 = __quote(__content_139865838111856_166, '\x00', '&#0;', None, False)
                __content_139865838111856 = ('%s%s%s%s%s%s%s%s' % ((__content_139865838111856 if (__content_139865838111856 is not None) else ''), ' ', (__content_139865838111856_97 if (__content_139865838111856_97 is not None) else ''), ' Introduced: ', (__content_139865838111856_139 if (__content_139865838111856_139 is not None) else ''), '; Speed: ', (__content_139865838111856_166 if (__content_139865838111856_166 is not None) else ''), 'mph', ))
                ...
                ____index_139865819861568 -= 1
                if (____index_139865819861568 > 0):
                    __append('')
            if (__backup_ship_139865821092776 is __marker):
                del econtext['ship']
            else:
                econtext['ship'] = __backup_ship_139865821092776
            ...
            # <Static value=<_ast.Dict object at 0x7f350ca62a90> name=None at 7f350ca62748> -> __attrs_139865819864816
            __attrs_139865819864816 = _static_139865822210704
