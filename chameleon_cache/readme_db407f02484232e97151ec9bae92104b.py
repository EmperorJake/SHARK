# -*- coding: utf-8 -*-
__filename = '/mnt/c/Users/Jakob/Games/GitHub/SHARK/src/docs_templates/readme.pt'
...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<_ast.Dict object at 0x7f80378ec8b0> name=None at 7f80378ec2e0> -> __attrs_140188663600368
            __attrs_140188663600368 = _static_140188664645808
            __backup_ship_140188662621664 = get('ship', __marker)

            # <Value 'ships' (3:35)> -> __iterator
            __token = 76
            __iterator = getitem('ships')
            (__iterator, ____index_140188663599360, ) = getitem('repeat')('ship', __iterator)
            econtext['ship'] = None
            for __item in __iterator:
                econtext['ship'] = __item

                # <Interpolation value=<Substitution "${ship.title} ${' ' * (28-len(ship.title))} Introduced: ${ship.intro_date}; Speed: ${ship.speed}mph" (3:42)> braces_required=True translation=False default='"?"' default_marker='"?"' at 7f80377ed1f0> -> __content_140188669528304
                __token = 83
                __token = 85
                __content_140188669528304 = _lookup_attr(getitem('ship'), 'title')
                __content_140188669528304 = __quote(__content_140188669528304, '\x00', '&#0;', None, None)
                __token = 99
                __content_140188669528304_97 = (' ' * (28 - len(_lookup_attr(getitem('ship'), 'title'))))
                __content_140188669528304_97 = __quote(__content_140188669528304_97, '\x00', '&#0;', None, None)
                __token = 141
                __content_140188669528304_139 = _lookup_attr(getitem('ship'), 'intro_date')
                __content_140188669528304_139 = __quote(__content_140188669528304_139, '\x00', '&#0;', None, None)
                __token = 168
                __content_140188669528304_166 = _lookup_attr(getitem('ship'), 'speed')
                __content_140188669528304_166 = __quote(__content_140188669528304_166, '\x00', '&#0;', None, None)
                __content_140188669528304 = ('%s%s%s%s%s%s%s%s' % ((__content_140188669528304 if (__content_140188669528304 is not None) else ''), ' ', (__content_140188669528304_97 if (__content_140188669528304_97 is not None) else ''), ' Introduced: ', (__content_140188669528304_139 if (__content_140188669528304_139 is not None) else ''), '; Speed: ', (__content_140188669528304_166 if (__content_140188669528304_166 is not None) else ''), 'mph', ))
                ...
                ____index_140188663599360 -= 1
                if (____index_140188663599360 > 0):
                    __append('')
            if (__backup_ship_140188662621664 is __marker):
                del econtext['ship']
            else:
                econtext['ship'] = __backup_ship_140188662621664
            ...
            # <Static value=<_ast.Dict object at 0x7f80378ec8b0> name=None at 7f80378ec2e0> -> __attrs_140188663376864
            __attrs_140188663376864 = _static_140188664645808
