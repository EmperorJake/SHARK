...
def initialize(__loader, macros, nothing, template):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Interpolation value=<Substitution '// -- begin ${ship.title} -- ' (1:0)> braces_required=True translation=False at 7f29f418d6d8> -> __content_139818181960344
            __token = 0
            __token = 14
            ...
            __content_139818181960344 = ('%s%s%s' % ('// -- begin ', (__content_139818181960344 if (__content_139818181960344 is not None) else ''), ' -- ', ))
